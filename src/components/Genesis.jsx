...
export default function Genesis() {
    return (
        <section className="relative bg-[url('/img/genesisbg.jpg')] bg-no-repeat min-h-[510px] bg-[length:2560px_605px] bg-center">
            <div className="p-[80px_40px_70px] text-center w-[530px] mx-auto ">
                <h3 className="text-3xl uppercase font-black text-primary mb-9">
                    The genesis
                </h3>
                <p className="block mb-2 text-[17px] leading-5 font-light text-primary">
